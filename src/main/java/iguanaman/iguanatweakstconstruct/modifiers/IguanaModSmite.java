...
public class IguanaModSmite extends ToolMod {

    String tooltipName;
	int increase;
    int max;

	public IguanaModSmite(ItemStack[] items, int effect, int inc) {
    ...
    public void modify (ItemStack[] input, ItemStack tool)
    {
        ...
        else
        {
            ...
            modifiers -= 1;
            tags.setInteger("Modifiers", modifiers);
            String modName = "\u00a7e" + "Smite" + " (" + increase + "/" + max + ")";
    ...
    void updateModTag (ItemStack tool, int[] keys)
    {
    	...
    	String modName = "\u00a7e" + "Smite" + " (" + keys[0] + "/" + keys[1] + ")";
